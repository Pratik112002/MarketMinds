...
class ScienceNews : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_science_news) // Update this with your activity's layout
    ...
    private fun fetchNews() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val response = service.getTopHeadlines(category = "science", pageSize = 100,apiKey = "977b51ac6dfd4e93a2709f65b3b6ddc6") // Replace with your API key
            ...
            withContext(Dispatchers.Main) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@ScienceNews, "Failed to load news", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
