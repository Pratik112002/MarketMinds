...
class HealthNews : AppCompatActivity() {
    private lateinit var recyclerView: RecyclerView
    private lateinit var newsAdapter: NewsAdapter // Assuming you have created an adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_health_news) // Update this with your activity's layout
    ...
    private fun fetchNews() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val response = service.getTopHeadlines(category = "health", pageSize = 100,apiKey = "977b51ac6dfd4e93a2709f65b3b6ddc6") // Replace with your API key
            ...
            withContext(Dispatchers.Main) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@HealthNews, "Failed to load news", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
